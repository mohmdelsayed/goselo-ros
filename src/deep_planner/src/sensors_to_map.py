...
class publish_input_maps:
	...
	if (self.curr_locX == None) or (self.curr_locY == None) or (self.goal_locX == None) or (self.goal_locY == None):
        ...
        cv2.imshow( 'Thresholded Map', the_map )
 	...
 	# yA = int(round((self.curr_locX-data.info.origin.position.x)/data.info.resolution))
        # xA = int(round((self.curr_locY-data.info.origin.position.y)/data.info.resolution))

 	# yB = int(round((self.curr_locX-data.info.origin.position.x)/data.info.resolution))
        # xB = int(round((self.curr_locY-data.info.origin.position.y)/data.info.resolution))
